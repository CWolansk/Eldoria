...
function createClassOptionSelection(choice) {
    const selectedOptions = choice.options
        ...
        .map((option) => ({
            ...
            recordId: option.recordId || option.catalogId || option.id || option.ref || "",
            catalogKind: option.catalogKind || "",
            refType: option.refType || "",
            classFeature: option.classFeature || "",
            subclassFeature: option.subclassFeature || "",
            optionalfeature: option.optionalfeature || "",
