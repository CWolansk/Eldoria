...
- **Location:** Rolling hills southwest of Highreach, north of Forgepeak
- **Government:** Village Elder (Elder Thomlin Hillshaw)
- **Population:** ~500 (Mostly Human, some Gnomes)
- **Defenses:** Volunteer militia
- **Primary Export:** Cider apples, wool, hilltop honey

Banner
- Three green hills beneath blue sky

```
Hillcrest perches on a series of rolling hills overlooking fertile valleys, its name describing both location and character. The village serves as a rest stop for travelers heading to or from Forgepeak, known for its excellent view of sunrise over the distant mountains and the warm hospitality of its residents.

The air is crisp and carries the scent of apple orchards and wildflowers. Sheep dot the hillsides, and the sound of a working forge echoes across the valley.
```
...
**Key Areas:**
- **Village Green (Central Hill)**
	- Ancient oak tree where seasonal festivals are held
	- Elder's cottage overlooks the green
	- Community gathering space
- **Market Row**
	- Small collection of essential services
	- Gruk's Forge & General Goods (combined smithy and shop)
- **Hill Farms**
	- Scattered homesteads on surrounding hillsides
	- Sheep and cattle grazing on slopes
	- Apple orchards producing the region's finest cider
- **The Gnome Burrows**
	- Small community of Gnomish families in hillside homes
	- Known for clockwork repairs and tinkering
...
**Services & Wares:**
- **Smithing:**
    - Weapon crafting and repair (simple and martial weapons)
    - Armor repair (light and medium, can work on heavy armor with time)
    - Agricultural tools (plows, scythes, horseshoes)
    - Custom metalwork (takes commissions)
- **General Goods:**
    - Basic adventuring supplies (rope, pitons, lanterns)
    - Travel rations and common goods
    - Bulk hardware (nails, hinges, chains)
- **Specialty:**
...
**Public Knowledge:**
- **Master Craftsman:** His work is some of the best outside of Forgepeak. Dwarves have grudgingly admitted his skill.
- **Earned Respect:** Gruk doesn't demand respect for his race—he earns it through his work. This is both admirable and exhausting.
- **No Sob Stories:** He doesn't complain or share his struggles. He simply works harder than anyone else.
- **Community Member:** After fifteen years, he's part of Hillcrest, but always slightly apart. He's invited to festivals but sits at the edge. He's trusted but still watched.
...
### The Oak & Apple Inn
**Type:** Inn & Tavern  
**Proprietor:** Merry Applewood (Gnome)  
**Location:** Base of the central hill

A cozy inn built into the hillside, known for its apple cider (both regular and hard varieties) and comfortable beds. The common room has a massive fireplace and the best view of the valley sunset.

**Services:**
- Rooms (5sp per night, includes breakfast)
- Famous apple cider and hearty meals
- Local gossip and travelers' tales
...
- **The Dwarven Challenge:** A traveling dwarf smith has publicly challenged Gruk's craftsmanship. The village is divided—some want to defend their smith, others see an opportunity to "prove" dwarven superiority.
- **The Lost Flock:** Sheep have gone missing from the high pastures. Investigation reveals a griffin has nested nearby and is hunting livestock.
- **Gnomish Tinkering:** The gnome community has created a clockwork irrigation system, but it's malfunctioning and flooding the apple orchards. They need help debugging a complex mechanical puzzle.
- **Cider Festival:** The annual Harvest Festival is approaching, and someone has sabotaged several barrels of the ceremonial cider. Village politics and pride are at stake.
