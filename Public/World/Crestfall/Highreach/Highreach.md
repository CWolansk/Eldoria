...
- Tools (lockpicks, crowbars, spyglasses, whetstones)
...
- Enchanted artifacts
- Potions and alchemical components
- Arcane consultation available

**Features:** Floating light orbs, arcane symbols on walls, crystal ball centerpiece
...
**Interior Layout:**
- Reception area with quest board and attendants
- Main hall with grand staircase
- Upper floors (access via stairs)
...
**Interior:** Reception hall, main meeting room with long table, archives of trade documents and ledgers
