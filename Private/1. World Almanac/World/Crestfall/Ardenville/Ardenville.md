...
- **Cliffside Port.** On the southern edge of Lake arden is a small warehouse where select goods are sent up to [[Public/World/Crestfall/Highreach/Highreach|Highreach]] via a manually operated elevator. This elevator is ran by the merchants guild and fisherman must pay a high price if they want to send their goods on the elevator.
